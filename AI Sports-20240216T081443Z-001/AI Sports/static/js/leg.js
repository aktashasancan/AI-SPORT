...
videofolder.addEventListener('change', function(event) {
  ...
  function onResults(results) {
    ...
    drawLandmarks(canvasCtxFolder, results.poseLandmarks,
                  ...
                  const R_shoulderx = landmarks[24].x;
                  const R_shouldery = landmarks[24].y;
                  const R_elbowx = landmarks[26].x;
                  const R_elbowy = landmarks[26].y;
                  const R_wristx = landmarks[28].x;   
                  const R_wristy = landmarks[28].y;  


                  let angle_R_elbow = calculateAngle(R_shoulderx,R_shouldery,R_elbowx,R_elbowy,R_wristx,R_wristy);

                  let angle_L_elbow = calculateAngle(R_shoulderx,R_shouldery,R_elbowx,R_elbowy,R_wristx,R_wristy);
